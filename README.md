...
A lightweight Node.js utility for seeding a local wiki-style dataset from image metadata to https://github.com/cithukyaw/dream-wiki deployed at [dreamwiki.lovable.app](https://dreamwiki.lovable.app/). This repository contains small scripts and utilities used to fetch, process, and save metadata and image-related JSON output into an organized `output/` folder.
